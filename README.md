...
- Independent live Yoto authorization/account sync: awaiting user authorization
- Sonos playback: awaiting account verification and explicit audible-test approval
